...
const siteData = {
  ...
  artists: [
    { name: 'Aksomaniac', image: artistAksomaniac, imageScale: 1.22, imagePosition: 'center 12%' },
    { name: 'Anirudh Ravichander', image: artistAnirudh, imageScale: 1.17, imagePosition: 'center top' },
    { name: 'Sai Abhyankkar', image: artistSai, imageScale: 1.18, imagePosition: 'center top' },
    { name: 'Olivia Rodrigo', image: artistOlivia, imageScale: 1.16, imagePosition: 'center top' },
  ],
